  ...
  ((v, o) => {
    ...
    var o =
        typeof self < "u"
          ...
          : {},
      f,
      C = !o.document && !!o.postMessage,
      u = o.IS_PAPA_WORKER || !1,
      y = {},
      N = 0,
      n = {};
    function d(e) {
      (this._handle = null),
        ...
        (this.parseChunk = function (t, r) {
          ...
          if (this.isFirstChunk && 0 < s) {
            ...
            p ||
              ...
              (p = this._handle.guessLineEndings(t, i))),
              (t = [...t.split(p).slice(s)].join(p));
          }
          this.isFirstChunk &&
          ...
          if (!this._handle.paused() && !this._handle.aborted()) {
            if (
              ...
              o.postMessage({ results: i, workerId: n.WORKER_ID, finished: s });
            else if (T(this._config.chunk) && !r) {
              if (
        ...
        (this._sendError = function (t) {
          T(this._config.error)
            ...
            : u &&
              this._config.error &&
              o.postMessage({ workerId: n.WORKER_ID, error: t, finished: !1 });
        });
    }
    function S(e) {
      var t;
        ...
        (this._readChunk = function () {
          if (this._finished) this._chunkLoaded();
            ...
            if (
              ...
              C ||
                ((t.onload = re(this._chunkLoaded, this)),
                (t.onerror = re(this._chunkError, this))),
              t.open(
    ...
    function q(e) {
      ...
      (this.stream = function (i) {
        (this._input = i),
          ...
          s
            ? (((t = new FileReader()).onload = re(this._chunkLoaded, this)),
              (t.onerror = re(this._chunkError, this)))
    ...
    function K(e) {
      ...
      (this.pause = function () {
        ...
        (this._streamData = re(function (i) {
          try {
            t.push(
        ...
        (this._streamError = re(function (i) {
          this._streamCleanUp(), this._sendError(i);
        }, this)),
        (this._streamEnd = re(function () {
          this._streamCleanUp(), (s = !0), this._streamData("");
        }, this)),
        (this._streamCleanUp = re(function () {
    ...
    function ie(e) {
      ...
      function L() {
        if (
          (a &&
            ...
            (s = !1)),
          e.skipEmptyLines &&
            (a.data = a.data.filter(function (W) {
              return !D(W);
            })),
          M())
        ) {
          let W = function (B, R) {
            T(e.transformHeader) && (B = e.transformHeader(B, R)), _.push(B);
          };
          var g = W;
          if (a)
            if (Array.isArray(a.data[0])) {
              for (var A = 0; M() && A < a.data.length; A++)
                a.data[A].forEach(W);
              a.data.splice(0, 1);
            } else a.data.forEach(W);
        }
        function k(W, B) {
          for (var R = e.header ? {} : [], E = 0; E < W.length; E++) {
            var m = E,
              z = W[E],
              z = ((x, O) =>
                ((j) => (
                  ...
                  ? O === "true" ||
                    ...
                    (O !== "false" &&
                      O !== "FALSE" &&
                      (((j) => {
                        if (V.test(j) && ((j = parseFloat(j)), F < j && j < p))
                          return 1;
                      })(O)
                        ? parseFloat(O)
                        : Q.test(O)
                        ...
                        : O))
                  : O)(
                (m = e.header ? (E >= _.length ? "__parsed_extra" : _[E]) : m),
                (z = e.transform ? e.transform(z, m) : z)
              );
            m === "__parsed_extra"
              ? ((R[m] = R[m] || []), R[m].push(z))
              : (R[m] = z);
        ...
        a &&
          ...
          ((G = 1),
          !a.data.length || Array.isArray(a.data[0])
            ? ((a.data = a.data.map(k)), (G = a.data.length))
            : (a.data = k(a.data, 0)),
          e.header && a.meta && (a.meta.fields = _),
          (l += G));
      }
      function M() {
      ...
      T(e.step) &&
              ...
              : (L(),
                a.data.length !== 0 &&
                  ...
                  e.preview && I > e.preview
                    ? r.abort()
                    : ((a.data = a.data[0]), i(a, b))));
        })),
        (this.parse = function (A, k, G) {
          var g = e.quoteChar || '"',
            g =
              (e.newline || (e.newline = this.guessLineEndings(A, g)),
              (s = !1),
              e.delimiter
                ? T(e.delimiter) &&
                ...
                : ((g = ((W, B, R, E, m) => {
                      ...
                      for (
                        ...
                        R && D(H.data[te])
                          ...
                          : ((X = H.data[te].length),
                            ...
                            O === void 0
                              ? (O = X)
                              : 0 < X && (($ += Math.abs(X - O)), (O = X)));
                      0 < H.data.length && (Z /= H.data.length - P),
                        (x === void 0 || $ <= x) &&
                          (j === void 0 || j < Z) &&
                          1.99 < Z &&
                          ((x = $), (z = ce), (j = Z));
                    ...
                    ? (e.delimiter = g.bestDelimiter)
                    : ((s = !0), (e.delimiter = n.DefaultDelimiter)),
                  (a.meta.delimiter = e.delimiter)),
              ge(e));
          return (
            ...
            (a = r.parse(t, k, G)),
            L(),
            U ? { meta: { paused: !0 } } : a || { meta: { paused: !1 } }
          );
        }),
        ...
        (this.pause = function () {
          (U = !0),
            r.abort(),
            (t = T(e.chunk) ? "" : t.substring(r.getCharIndex()));
        }),
        (this.resume = function () {
          b.streamer._halted
            ? ((U = !1), b.streamer.parseChunk(t, !0))
        ...
        (this.abort = function () {
          (c = !0),
            r.abort(),
            (a.meta.aborted = !0),
            T(e.complete) && e.complete(a),
            (t = "");
        }),
        (this.guessLineEndings = function (W, g) {
          W = W.substring(0, 1048576);
          var g = new RegExp(se(g) + "([^]*?)" + se(g), "gm"),
            G = (W = W.replace(g, "")).split("\r"),
            g = W.split(`
`),
            W = 1 < g.length && g[0].length < G[0].length;
          if (G.length === 1 || W)
            return `
`;
          for (var B = 0, R = 0; R < G.length; R++)
            G[R][0] ===
              `
` && B++;
          return B >= G.length / 2
...
`
    ...
    function ue(e) {
      var t = (e = e || {}).delimiter,
        ...
        V = null,
        Q = !1,
        b = e.quoteChar == null ? '"' : e.quoteChar,
        I = b;
      if (
        (e.escapeChar !== void 0 && (I = e.escapeChar),
        (typeof t != "string" || -1 < n.BAD_DELIMITERS.indexOf(t)) && (t = ","),
        s === t)
      )
        throw new Error("Comment character same as delimiter");
      s === !0
        ? (s = "#")
        : (typeof s != "string" || -1 < n.BAD_DELIMITERS.indexOf(s)) &&
          (s = !1),
        r !==
          `
` &&
...
`);
      ...
      (this.parse = function (c, _, a) {
        ...
        var D = c.length,
          ...
          W = (l = 0);
        if (!c) return $();
        if (F || (F !== !1 && c.indexOf(b) === -1)) {
          for (var B = c.split(r), R = 0; R < B.length; R++) {
            if (((g = B[R]), (l += g.length), R !== B.length - 1))
              l += r.length;
            else if (a) return $();
            if (!s || g.substring(0, Y) !== s) {
              if (A) {
                if (((k = []), j(g.split(t)), Z(), U)) return $();
              } else j(g.split(t));
              if (p && p <= R) return (k = k.slice(0, p)), $(!0);
            }
          }
          return $();
        }
        for (
          ...
          if (c[l] === b)
            for (x = l, l++; ; ) {
              ...
              if (x === D - 1) return X(c.substring(l, x).replace(z, b));
              if (b === I && c[x + 1] === I) x++;
              else if (b === I || x === 0 || c[x - 1] !== I) {
                E !== -1 && E < x + 1 && (E = c.indexOf(t, x + 1));
                var O = ae(
                  (m = m !== -1 && m < x + 1 ? c.indexOf(r, x + 1) : m) === -1
                    ? E
                    : Math.min(E, m)
                );
                if (c.substr(x + 1 + O, L) === t) {
                  g.push(c.substring(l, x).replace(z, b)),
                    c[(l = x + 1 + O + L)] !== b && (x = c.indexOf(b, l)),
                    (E = c.indexOf(t, l)),
                    (m = c.indexOf(r, l));
                  break;
                }
                if (
                  ((O = ae(m)), c.substring(x + 1 + O, x + 1 + O + M) === r)
                ) {
                  if (
                    (g.push(c.substring(l, x).replace(z, b)),
                    ce(x + 1 + O + M),
          ...
          else if (s && g.length === 0 && c.substring(l, l + Y) === s) {
            if (m === -1) return $();
            (l = m + M), (m = c.indexOf(r, l)), (E = c.indexOf(t, l));
          } else if (E !== -1 && (E < m || m === -1))
            g.push(c.substring(l, E)), (l = E + L), (E = c.indexOf(t, l));
          else {
            if (m === -1) break;
            if ((g.push(c.substring(l, m)), ce(m + M), A && (Z(), U)))
              return $();
            if (p && k.length >= p) return $(!0);
          }
        return X();
        ...
        function ae(P) {
          var H = 0;
          return (H =
            P !== -1 && (P = c.substring(x + 1, P)) && P.trim() === ""
              ? P.length
              : H);
        }
        function X(P) {
        ...
        function ce(P) {
          (l = P), j(g), (g = []), (m = c.indexOf(r, l));
        }
        function $(P) {
          if (e.header && !_ && k.length && !Q) {
            var H = k[0],
            ...
            for (let oe = 0; oe < H.length; oe++) {
              let ee = H[oe];
              if (
                te[(ee = T(e.transformHeader) ? e.transformHeader(ee, oe) : ee)]
              ) {
                let de,
                  we = te[ee];
                for (; (de = ee + "_" + we), we++, me.has(de); );
                me.add(de),
                  (H[oe] = de),
                  te[ee]++,
                  (be = !0),
                  ((V = V === null ? {} : V)[de] = ee);
              } else (te[ee] = 1), (H[oe] = ee);
              me.add(ee);
            }
    ...
    function pe(e) {
      ...
      if (t.error) r.userError(t.error, t.file);
        ...
        var i = {
          abort: function () {
            (s = !0),
              he(t.workerId, { data: [], errors: [], meta: { aborted: !0 } });
          },
          pause: ye,
          resume: ye,
        };
        if (T(r.userStep)) {
          for (
            var p = 0;
            p < t.results.data.length &&
            (r.userStep(
              {
                data: t.results.data[p],
      ...
      t.finished && !s && he(t.workerId, t.results);
    }
    function he(e, t) {
      var r = y[e];
      T(r.userComplete) && r.userComplete(t), r.terminate(), delete y[e];
    }
    function ye() {
    ...
    return (
      (n.parse = function (e, t) {
        ...
        if (
          (T(r) && ((t.dynamicTypingFunction = r), (r = {})),
          (t.dynamicTyping = r),
          (t.transform = !!T(t.transform) && t.transform),
          !t.worker || !n.WORKERS_SUPPORTED)
        )
          return (
            (r = null),
            n.NODE_STREAM_INPUT,
            typeof e == "string"
              ? ((e = ((s) => (s.charCodeAt(0) !== 65279 ? s : s.slice(1)))(e)),
                (r = new (t.download ? S : J)(t)))
              : e.readable === !0 && T(e.read) && T(e.on)
              ? (r = new K(t))
        ...
        ((r = (() => {
          ...
          return (
            !!n.WORKERS_SUPPORTED &&
            ((s = (() => {
              var i = o.URL || o.webkitURL || null,
                p = v.toString();
              return (
                n.BLOB_URL ||
                (n.BLOB_URL = i.createObjectURL(
                  new Blob(
                    [
...
`,
              ...
              if (typeof t == "object") {
                if (
                  (typeof t.delimiter != "string" ||
                    n.BAD_DELIMITERS.filter(function (_) {
                  ...
                  (typeof t.skipEmptyLines != "boolean" &&
                    ...
                    (Q = t.skipEmptyLines),
                  typeof t.newline == "string" && (p = t.newline),
                  typeof t.quoteChar == "string" && (F = t.quoteChar),
                ...
                t.escapeChar !== void 0 && (V = t.escapeChar + F),
        ...
        if ((typeof e == "string" && (e = JSON.parse(e)), Array.isArray(e))) {
          if (!e.length || Array.isArray(e[0])) return U(null, e, Q);
          if (typeof e[0] == "object") return U(b || Object.keys(e[0]), e, Q);
        } else if (typeof e == "object")
          return (
            typeof e.data == "string" && (e.data = JSON.parse(e.data)),
            Array.isArray(e.data) &&
              (e.fields || (e.fields = (e.meta && e.meta.fields) || b),
              e.fields ||
        ...
        function U(_, a, D) {
          ...
          for (var k = 0; k < a.length; k++) {
            var G = (M ? _ : a[k]).length,
              g = !1,
              W = M ? Object.keys(a[k]).length === 0 : a[k].length === 0;
            if (
              (D &&
                !M &&
                (g =
          ...
          return _ == null
            ...
            : ((L = !1),
              I &&
                ...
                I.test(_) &&
                ((_ = "'" + _), (L = !0)),
              (D = _.toString().replace(l, V)),
              (L =
                L ||
                r === !0 ||
                (typeof r == "function" && r(_, a)) ||
                (Array.isArray(r) && r[a]) ||
                ((M, Y) => {
                  for (var A = 0; A < Y.length; A++)
                    if (-1 < M.indexOf(Y[A])) return !0;
                  return !1;
                })(D, n.BAD_DELIMITERS) ||
                -1 < D.indexOf(i) ||
                D.charAt(0) === " " ||
...
`,
      ...
      (n.WORKERS_SUPPORTED = !C && !!o.Worker),
      ...
      (n.FileStreamer = q),
      (n.StringStreamer = J),
      (n.ReadableStreamStreamer = K),
      o.jQuery &&
        ((f = o.jQuery).fn.parse = function (e) {
          var t = e.config || {},
            r = [];
          return (
          ...
          function s() {
            if (r.length === 0) T(e.complete) && e.complete();
            else {
              var p,
                F,
                V,
                ...
                b = r[0];
              if (T(e.before)) {
                var I = e.before(b.file, b.inputElem);
                if (typeof I == "object") {
                  if (I.action === "abort")
                    return (
                      (p = "AbortError"),
                      ...
                      (V = b.inputElem),
                      (Q = I.reason),
                      void (T(e.error) && e.error({ name: p }, F, V, Q))
                    );
                  if (I.action === "skip") return void i();
                  typeof I.config == "object" &&
                    (b.instanceConfig = f.extend(b.instanceConfig, I.config));
                } else if (I === "skip") return void i();
              }
              var l = b.instanceConfig.complete;
              (b.instanceConfig.complete = function (U) {
                T(l) && l(U, b.file, b.inputElem), i();
              }),
                n.parse(b.file, b.instanceConfig);
            }
          }
          function i() {
            r.splice(0, 1), s();
      ...
      u &&
        (o.onmessage = function (e) {
          (e = e.data),
            n.WORKER_ID === void 0 && e && (n.WORKER_ID = e.workerId),
            typeof e.input == "string"
              ? o.postMessage({
                  workerId: n.WORKER_ID,
                  results: n.parse(e.input, e.config),
                  finished: !0,
                })
              : ((o.File && e.input instanceof File) ||
                  e.input instanceof Object) &&
                (e = n.parse(e.input, e.config)) &&
                o.postMessage({
                  workerId: n.WORKER_ID,
                  results: e,
                  finished: !0,
      ...
      ((S.prototype = Object.create(d.prototype)).constructor = S),
      ((q.prototype = Object.create(d.prototype)).constructor = q),
      ((J.prototype = Object.create(J.prototype)).constructor = J),
...
`;
function Re() {
  const h = Array.from(document.querySelectorAll("a")).filter(
      (n) => !n.closest("nav")
    ),
    v = new Map(),
    o = 50;
  for (const n of h) {
    ...
    const d = window.getComputedStyle(n),
      S =
        d.fontWeight === "700" ||
        d.fontWeight === "bold" ||
        parseInt(d.fontWeight) >= 700,
      q = d.textDecorationLine.includes("underline"),
      J = d.borderBottomStyle !== "none",
      K = `${d.color}|${d.backgroundColor}|${S}|${q}|${J}`;
    if (
      (v.has(K) ||
        v.set(K, {
          text: n.innerText.substring(0, 20),
          color: d.color,
          isUnderlined: q,
          isBold: S,
          hasBorder: J,
  ...
  const f = Array.from(v.values()),
    C = Array.from(document.querySelectorAll("input, textarea, select"));
  function u(n, d) {
    const S = window.getComputedStyle(n),
      q = window.getComputedStyle(d);
    if (S.color === q.color) return !1;
    const J = S.fontWeight !== q.fontWeight,
      K = S.fontStyle !== q.fontStyle,
      ie = S.textDecorationLine !== q.textDecorationLine,
      se = S.borderBottomStyle !== q.borderBottomStyle,
      ue = S.backgroundColor !== q.backgroundColor,
      pe = window.getComputedStyle(n, "::before").content !== "none",
      he = window.getComputedStyle(n, "::after").content !== "none";
    return !(J || K || ie || se || ue || pe || he);
  }
  const y = [],
    N = document.body.getElementsByTagName("*");
  for (const n of N)
    if (n.children.length === 0 && n.textContent.trim().length > 0) {
      ...
      d &&
        ...
        u(n, d) &&
        y.push({
          text: n.innerText.substring(0, 30),
  ...
  return {
    ...
    links: f,
    formElements: C.map((n) => {
      var K;
      const d = window.getComputedStyle(n),
        S = (K = n.labels) == null ? void 0 : K[0],
        q = n.getAttribute("aria-describedby");
      let J = "";
      if (q) {
      ...
      return {
        tagName: n.tagName.toLowerCase(),
        label: S == null ? void 0 : S.innerText.substring(0, 30),
        color: d.color,
        borderColor: d.borderColor,
        isRequired: n.required,
        isInvalid: n.getAttribute("aria-invalid") === "true",
        hasVisibleLabelAsterisk:
          (S == null ? void 0 : S.innerText.includes("*")) ?? !1,
        hasDescribedByError: J.trim().length > 0,
      };
    }),
    textFragments: y,
  };
...
const Oe = Object.freeze(
    Object.defineProperty(
      { __proto__: null, earlId: Te, extractor: Re, id: Ce, systemPrompt: We },
      Symbol.toStringTag,
      { value: "Module" }
    )
  ),
  ve = "1.3.2",
  Ie = "WCAG22:meaningful-sequence",
  Ge = `
You are a strict accessibility auditor who writes in plain, easy-to-understand language.
...
function Le() {
  const w = [],
    h = Array.from(document.querySelectorAll("*"));
  for (const u of h) {
    ...
    let S = "";
    N !== "0" && (S += `order: ${N}; `),
      (n === "left" || n === "right") && (S += `float: ${n}; `),
      (d === "row-reverse" || d === "column-reverse") &&
        (S += `flex-direction: ${d}; `),
      S &&
        w.push({
  ...
  const v = Array.from(document.querySelectorAll("table"))
      .filter(
        (u) =>
          u.getAttribute("role") === "presentation" ||
          (!u.querySelector("th") && !u.querySelector("caption"))
      )
      .map((u) => ({ html: u.outerHTML.substring(0, 500) })),
    o = [],
    f = document.createTreeWalker(document.body, NodeFilter.SHOW_TEXT);
  let C;
  for (; (C = f.nextNode()); ) {
    const u = C.nodeValue;
    if (u && (u.match(/\\w\\s{2,}\\w/g) || u.match(/&nbsp;.*&nbsp;/g))) {
      const y = C.parentElement;
      y &&
        y.offsetParent !== null &&
        !o.some((N) => N.text === y.textContent.trim().substring(0, 100)) &&
        o.push({
          tagName: y.tagName.toLowerCase(),
          text: y.textContent.trim().substring(0, 100),
        });
    }
  }
  return {
    orderingProperties: w,
    layoutTables: v,
    elementsWithBadWhitespace: o,
  };
}
const Fe = Object.freeze(
    Object.defineProperty(
      { __proto__: null, earlId: Ie, extractor: Le, id: ve, systemPrompt: Ge },
      Symbol.toStringTag,
      { value: "Module" }
    )
  ),
...
function je(w) {
  const h = new Date().toISOString(),
    v = "_:website",
    o = [...new Set(w.map((y) => y.url))],
    f = o.map((y, N) => {
      const n = w.find((S) => S.url === y),
        d = n && n.pageTitle ? n.pageTitle : y;
      return {
        id: `_:page_${N + 1}`,
    ...
    C = o.reduce((y, N, n) => ((y[N] = `_:page_${n + 1}`), y), {}),
    u = [];
  return (
    De.forEach((y) => {
      const N = w.filter((d) => d.earlId === y);
      let n = !1;
      N.length > 0 &&
        ((n = !0),
        N.forEach((d) => {
          ...
          u.push({
            ...
            subject: { id: C[d.url] },
            test: { id: y, type: ["TestCriterion", "TestRequirement"] },
          });
        })),
        n ||
          u.push({
...
let le = [],
  fe = [];
document.getElementById("csvFile").addEventListener("change", (w) => {
    ...
    Ee.parse(h, {
      ...
      complete: (v) => {
        (le = v.data
          ...
          .map((o) => o.url)),
          le.length > 0
            ? (ne(`✅ Loaded ${le.length} URLs.`),
              (document.getElementById("startBtn").disabled = !1))
            : ne("❌ No valid URLs found. Check CSV headers.");
      },
    });
});
document.getElementById("startBtn").addEventListener("click", async () => {
  ...
  for (let w = 0; w < le.length; w++) {
    ...
    try {
      ...
      const v = await Pe(),
        o = Be(v.id);
      await chrome.tabs.update(v.id, { url: h }),
        await o,
        ne("Analyzing DOM...");
      for (const f in _e) {
        const C = _e[f];
        try {
          const u = await Ne(v.id, C),
            y =
              u.verdict === "FAIL" ? "❌" : u.verdict === "PASS" ? "✅" : "⚠️";
          ne(`[${f}] ${y} ${u.verdict}`),
            fe.push({ url: h, earlId: C.earlId, ...u });
        } catch (u) {
          console.error(u),
            ne(`⚠️ Error [${f}]: ${u.message}`),
            fe.push({
              url: h,
              earlId: C.earlId,
              verdict: "ERROR",
...
async function Ne(w, h) {
  ...
  try {
    ...
    if (!o || !o[0]) throw new Error("Script injection failed");
    const f = o[0].result,
      C =
        ((v = window.ai) == null ? void 0 : v.languageModel) ||
    ...
    const u = await C.create({
        initialPrompts: [{ role: "system", content: h.systemPrompt }],
        expectedOutputs: [{ type: "text", languages: ["en"] }],
      }),
      y = await u.prompt(JSON.stringify(f)),
      N = y.match(/\{[\s\S]*\}/);
    if (!N)
      throw (
        (console.error("Raw AI Output:", y),
        new Error(`No JSON found in output. Raw: "${y.substring(0, 20)}..."`))
      );
    const n = JSON.parse(N[0]);
    return u.destroy(), { ...n, pageTitle: f.pageTitle };
  } catch (o) {
    throw o;
  }
}
function Be(w) {
  return new Promise(async (h) => {
    try {
      if ((await chrome.tabs.get(w)).status === "complete") {
        setTimeout(h, 1e3);
        return;
      }
    } catch {}
    const v = (o, f) => {
      o === w &&
        f.status === "complete" &&
        (chrome.tabs.onUpdated.removeListener(v), setTimeout(h, 1e3));
    };
...
function qe(w, h, v) {
  (document.getElementById("progress").textContent = `${w}/${h}`),
    (document.getElementById("currentUrl").textContent = v);
}
function ne(w) {
...
function Me() {
  ...
  const w = je(fe),
    h = new Blob([JSON.stringify(w, null, 2)], { type: "application/json" }),
    v = URL.createObjectURL(h),
    o = document.getElementById("downloadBtn");
  (o.style.display = "block"),
    (o.onclick = () => {
      chrome.downloads.download({ url: v, filename: "nano-audit-report.json" });
    }),
    ne("🏁 Done. Download your report.");
}
